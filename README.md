...
Interactive API documentation (Swagger UI) is auto-generated by FastAPI and served at
`http://localhost:8000/docs`, with the ReDoc alternative available at `/redoc`.
